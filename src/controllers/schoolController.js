class SchoolController {
    ...
    async addSchool(req, res) {
        ...
        try {
            const newSchool = await this.schoolModel.insertSchool({ name, address, latitude, longitude });
    ...
    async listSchools(req, res) {
        ...
        try {
            ...
            const sortedSchools = this.sortSchoolsByDistance(schools, { latitude, longitude });
